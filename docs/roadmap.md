...
- [x] **Substituir a paleta forest/amber/cream pelo design system teal/areia**
  (`interface/tema.py`, `.streamlit/config.toml`, 2026-09-16) — paleta,
  tipografia (Spectral/Source Sans 3/IBM Plex Mono), forma (pill nos
  controles, raio 14px nos cards) e cor por estado de resposta
